...
//    private static String resultsFileName = "testResults.txt";
    public static void main(String[] args) {//主函数入口
        ...
        TestFunc6and2_generate(graph);

      //          TestFunc3_brige(graph);
       // TestFunc4_generate(graph);
              TestFunc5_path(graph);
...
//         graph.selfprintmatrix();//打印邻接矩阵
     ...
     static void TestFunc3_brige(CGraph graph){
      //   ReadFile();
     //    CGraph graph = readWordsToGraph();
     ...
     static void TestFunc4_generate(CGraph graph){
    //     ReadFile();
     //    CGraph graph = readWordsToGraph();
         Scanner scanner = new Scanner(System.in);
         while(true){
     ...
     static void TestFunc5_path(CGraph graph){
      //   ReadFile();
     //    CGraph graph = readWordsToGraph();
         Scanner scanner = new Scanner(System.in);
         while(true){
    ...
    static void TestFunc6and2_generate(CGraph graph){
     //   ReadFile();
      //  CGraph graph = readWordsToGraph();
        graph.Randomwalk();
